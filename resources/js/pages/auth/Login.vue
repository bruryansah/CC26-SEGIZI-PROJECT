    ...
    <div class="min-h-screen bg-white flex text-gray-900 font-sans">
        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 lg:p-24 relative">
            <div class="w-full max-w-[400px]">
                <h1 class="text-5xl font-black text-center text-black mb-12">Masuk</h1>
                ...
                <Form v-bind="store.form()" :reset-on-success="['password']" v-slot="{ errors, processing }" class="flex flex-col gap-6">
                    ...
                    <div class="text-center">
                        <Link :href="request.url()" class="text-sm font-bold text-black hover:text-[#36d362] transition">
                            Lupa Password?
                        </Link>
                    </div>
                    ...
                    <button 
                        type="submit" 
                        class="w-full bg-[#36d362] text-white font-bold text-lg rounded-[12px] py-3.5 hover:bg-green-600 transition shadow-sm flex items-center justify-center gap-2"
                        :disabled="processing"
                    >
        ...
        <div class="hidden lg:flex w-1/2 bg-[#36d362] rounded-l-[100px] flex-col items-center justify-center text-white p-12 text-center my-[-20px]">
            <h2 class="text-5xl font-black mb-6">Halo, Selamat Datang!</h2>
            <p class="text-lg mb-8 font-medium">Belum punya akun?</p>
            <Link :href="register.url()" class="border-2 border-white px-14 py-3 rounded-xl font-bold text-lg hover:bg-white hover:text-[#36d362] transition shadow-md">
                Daftar
            </Link>
        </div>
    </div>
